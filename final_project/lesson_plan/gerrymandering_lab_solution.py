...
def change_coordinate(map, coord1, coord2):
  ...
  district1 = map[coord1[0]][coord1[1]]["district"]
  map[coord1[0]][coord1[1]]["district"] = map[coord2[0]][coord2[1]]["district"]
  map[coord2[0]][coord2[1]]["district"] = district1
  return map
...
map = change_coordinate(map, (4, 4), (3, 3))
map = change_coordinate(map, (4, 0), (1,2))
print_map(map)
who_win(map, district_count)